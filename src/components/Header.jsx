...
const Header = () => {
  ...
  return (
    <header
      className={`fixed top-0 z-40 flex w-full items-center justify-between  text-base transition-all sm:px-4 lg:px-28 lg:pt-2
      ${isScrolling ? "sticky" : ""}`}
    >
      <div className="my-[10px] cursor-none rounded-[50px] shadow-[0_1px_10px_1px_#ffffff22]">
        <img
          className="h-[70px] w-[auto] bg-cover bg-no-repeat  "
          src={I7kStudio}
          alt="logo"
        />
      </div>
        ...
        <div className="cursor-pointer items-center space-x-4 sm:flex sm:flex-col sm:gap-4 lg:flex lg:flex-row lg:gap-6">
          ...
          <div>
            <button
              ...
              className="button-UI  rounded-lg px-4 py-1.5 font-bold tracking-wider text-gray-900 shadow-xl hover:text-red-900"
            >
              Resume
            </button>
          </div>
